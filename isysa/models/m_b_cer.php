...
class M_b_cer extends ActiveRecord{
    protected static $tabla = 'm_b_cer';
    protected static $columnasDB = ['id', 'produc41_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc41_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc41_incen_id = $args['produc41_incen_id'] ?? '';
