...
class Tl_cer extends ActiveRecord{
    protected static $tabla = 'tl_cer';
    protected static $columnasDB = ['id', 'produc40_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc40_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc40_incen_id = $args['produc40_incen_id'] ?? '';
