...
class At_dir extends ActiveRecord{
    protected static $tabla = 'at_dir';
    protected static $columnasDB = ['id', 'produc27_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc27_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc27_incen_id = $args['produc27_incen_id'] ?? '';
