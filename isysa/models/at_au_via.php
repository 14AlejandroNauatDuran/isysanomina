...
class At_au_via extends ActiveRecord{
    protected static $tabla = 'at_au_via';
    protected static $columnasDB = ['id', 'produc44_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc44_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc44_incen_id = $args['produc44_incen_id'] ?? '';
