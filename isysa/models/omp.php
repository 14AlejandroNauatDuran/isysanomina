...
class Omp extends ActiveRecord{
    protected static $tabla = 'omp';
    protected static $columnasDB = ['id', 'produc11_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc11_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc11_incen_id = $args['produc11_incen_id'] ?? '';
