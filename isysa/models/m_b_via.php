...
class M_b_via extends ActiveRecord{
    protected static $tabla = 'm_b_via';
    protected static $columnasDB = ['id', 'produc43_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc43_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc43_incen_id = $args['produc43_incen_id'] ?? '';
