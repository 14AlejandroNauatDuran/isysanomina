...
class Ttv extends ActiveRecord{
    protected static $tabla = 'ttv';
    protected static $columnasDB = ['id', 'produc7_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc7_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc7_incen_id = $args['produc7_incen_id'] ?? '';
