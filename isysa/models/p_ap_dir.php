...
class P_ap_dir extends ActiveRecord{
    protected static $tabla = 'p_ap_dir';
    protected static $columnasDB = ['id', 'produc24_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc24_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc24_incen_id = $args['produc24_incen_id'] ?? '';
