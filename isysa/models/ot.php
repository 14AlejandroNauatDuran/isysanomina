...
class Ot extends ActiveRecord{
    protected static $tabla = 'ot';
    protected static $columnasDB = ['id', 'produc10_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc10_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc10_incen_id = $args['produc10_incen_id'] ?? '';
