...
class At_via extends ActiveRecord{
    protected static $tabla = 'at_via';
    protected static $columnasDB = ['id', 'produc31_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc31_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc31_incen_id = $args['produc31_incen_id'] ?? '';
