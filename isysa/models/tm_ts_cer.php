...
class Tm_ts_cer extends ActiveRecord{
    protected static $tabla = 'tm_ts_cer';
    protected static $columnasDB = ['id', 'produc33_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc33_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc33_incen_id = $args['produc33_incen_id'] ?? '';
