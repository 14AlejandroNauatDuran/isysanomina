...
class M_b_dir extends ActiveRecord{
    protected static $tabla = 'm_b_dir';
    protected static $columnasDB = ['id', 'produc42_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc42_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc42_incen_id = $args['produc42_incen_id'] ?? '';
