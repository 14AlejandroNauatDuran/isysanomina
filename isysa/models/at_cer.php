...
class At_cer extends ActiveRecord{
    protected static $tabla = 'at_cer';
    protected static $columnasDB = ['id', 'produc26_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc26_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc26_incen_id = $args['produc26_incen_id'] ?? '';
