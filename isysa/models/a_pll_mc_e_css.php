...
class A_pll_mc_e_css extends ActiveRecord{
    protected static $tabla = 'a_pll_mc_e_css';
    protected static $columnasDB = ['id', 'produc_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc_incen_id = $args['produc_incen_id'] ?? '';
