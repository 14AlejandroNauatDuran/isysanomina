...
class At_au_dir extends ActiveRecord{
    protected static $tabla = 'at_au_dir';
    protected static $columnasDB = ['id', 'produc39_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc39_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc39_incen_id = $args['produc39_incen_id'] ?? '';
