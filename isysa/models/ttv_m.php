...
class Ttv_m extends ActiveRecord{
    protected static $tabla = 'ttv_m';
    protected static $columnasDB = ['id', 'produc9_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc9_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc9_incen_id = $args['produc9_incen_id'] ?? '';
