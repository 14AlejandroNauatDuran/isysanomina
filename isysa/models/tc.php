...
class Tc extends ActiveRecord{
    protected static $tabla = 'Tc';
    protected static $columnasDB = ['id', 'produc12_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc12_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc12_incen_id = $args['produc12_incen_id'] ?? '';
