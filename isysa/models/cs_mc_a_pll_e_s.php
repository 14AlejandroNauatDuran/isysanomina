...
class Cs_mc_a_pll_e_s extends ActiveRecord{
    protected static $tabla = 'cs_mc_a_pll_e_s';
    protected static $columnasDB = ['id', 'produc4_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc4_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc4_incen_id = $args['produc4_incen_id'] ?? '';
