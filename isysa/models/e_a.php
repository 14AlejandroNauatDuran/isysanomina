...
class E_a extends ActiveRecord{
    protected static $tabla = 'e_a';
    protected static $columnasDB = ['id', 'produc25_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc25_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc25_incen_id = $args['produc25_incen_id'] ?? '';
