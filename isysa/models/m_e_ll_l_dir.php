...
class M_e_ll_l_dir extends ActiveRecord{
    protected static $tabla = 'm_e_ll_l_dir';
    protected static $columnasDB = ['id', 'produc36_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc36_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc36_incen_id = $args['produc36_incen_id'] ?? '';
