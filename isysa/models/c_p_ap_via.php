...
class C_p_ap_via extends ActiveRecord{
    protected static $tabla = 'c_p_ap_via';
    protected static $columnasDB = ['id', 'produc29_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc29_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc29_incen_id = $args['produc29_incen_id'] ?? '';
