...
class C_p_ap_cer extends ActiveRecord{
    protected static $tabla = 'c_p_ap_cer';
    protected static $columnasDB = ['id', 'produc23_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc23_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc23_incen_id = $args['produc23_incen_id'] ?? '';
