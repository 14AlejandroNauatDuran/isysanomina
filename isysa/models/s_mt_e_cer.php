...
class S_mt_e_cer extends ActiveRecord{
    protected static $tabla = 's_mt_e_cer';
    protected static $columnasDB = ['id', 'produc19_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc19_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc19_incen_id = $args['produc19_incen_id'] ?? '';
