...
class Amatto_s_mt_e_dir extends ActiveRecord{
    protected static $tabla = 'amatto_s_mt_e_dir';
    protected static $columnasDB = ['id', 'produc22_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc22_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc22_incen_id = $args['produc22_incen_id'] ?? '';
