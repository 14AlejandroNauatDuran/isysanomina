...
class Otx_amo extends ActiveRecord{
    protected static $tabla = 'otx_amo';
    protected static $columnasDB = ['id', 'produc16_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc16_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc16_incen_id = $args['produc16_incen_id'] ?? '';
