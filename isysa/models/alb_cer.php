...
class Alb_cer extends ActiveRecord{
    protected static $tabla = 'alb_cer';
    protected static $columnasDB = ['id', 'produc32_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc32_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc32_incen_id = $args['produc32_incen_id'] ?? '';
