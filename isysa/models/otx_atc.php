...
class Otx_atc extends ActiveRecord{
    protected static $tabla = 'otx_otc';
    protected static $columnasDB = ['id', 'produc17_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc17_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc17_incen_id = $args['produc17_incen_id'] ?? '';
