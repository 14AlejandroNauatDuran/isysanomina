...
class At_au_cer extends ActiveRecord{
    protected static $tabla = 'at_au_cer';
    protected static $columnasDB = ['id', 'produc38_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc38_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc38_incen_id = $args['produc38_incen_id'] ?? '';
