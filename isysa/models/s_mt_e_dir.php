...
class S_mt_e_dir extends ActiveRecord{
    protected static $tabla = 's_mt_e_dir';
    protected static $columnasDB = ['id', 'produc20_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc20_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc20_incen_id = $args['produc20_incen_id'] ?? '';
