...
class M_e_ll_l_cer extends ActiveRecord{
    protected static $tabla = 'm_e_ll_l_cer';
    protected static $columnasDB = ['id', 'produc35_incen_id','rangoA', 'rangoB', 'factor'];

    public $id ;
    public $produc35_incen_id;
    public $rangoA;
    public $rangoB;
    public $factor;
    ...
    public function __construct($args=[]){
        ...
        $this->produc35_incen_id = $args['produc35_incen_id'] ?? '';
